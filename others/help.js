...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      .setTitle("Billi Help")
      .setAuthor('Click here to invite me!!', 'https://cdn.discordapp.com/attachments/889793792041975828/890070746150363166/dj-old.gif', 'https://discord.com/api/oauth2/authorize?client_id=868379276913811467&permissions=137476042048&scope=bot')
      .setDescription(`**PREFIX:** \`${PREFIX}\``)
      .setFooter( client.user.username +`Type: ${PREFIX}help <Command>  for more information!`, "https://cdn.discordapp.com/attachments/889793792041975828/890070746150363166/dj-old.gif")
      .setColor("#F0EAD6");
